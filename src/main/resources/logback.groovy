...
appender('FILE', RollingFileAppender) {
    ...
    rollingPolicy(TimeBasedRollingPolicy) {
        FileNamePattern = "${System.getenv('LOG_PATH') ?: 'logs'}/potic-rank-coordinator.%d{yyyy-MM-dd}.log"
    }
}
...
logger('me.potic.rank.coordinator', Level.toLevel(SERVICE_LOG_LEVEL), [ 'STDOUT', 'FILE' ], false)
