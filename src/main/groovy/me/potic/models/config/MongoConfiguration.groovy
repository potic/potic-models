package me.potic.models.config
...
class MongoConfiguration extends AbstractMongoConfiguration {
    ...
    Mongo mongo() throws Exception {
        new MongoClient( new ServerAddress(host, port), [MongoCredential.createCredential(username, authenticationDatabaseName, getPassword())] )
    }
