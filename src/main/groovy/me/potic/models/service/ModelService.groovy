...
class ModelService {
    ...
    static final Model NB_0_2 = new Model(name: 'nb', version: '0.2', description: 'naive bayes (source, words count, showed count, skipped count)', timestamp: '2018-04-16', isActive: true)
